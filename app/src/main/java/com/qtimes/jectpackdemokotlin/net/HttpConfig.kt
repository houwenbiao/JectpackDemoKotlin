...
class HttpConfig {
    companion object{
        ...
        /*天气请求相关配置*/
        const val BASE_URL_DEFAULT = "http://op.juhe.cn/"
        const val BASE_URL_WEATHER = "http://op.juhe.cn/"
        const val KEY_WEATHER = "afc28ae28c6f1b520dab5d1ed537f6c0"
